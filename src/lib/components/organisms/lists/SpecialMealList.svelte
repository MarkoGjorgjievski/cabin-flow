...
{#if show}
  <div class='absolute top-0 left-0 w-full bg-base-100 menu px-0 py-4 shadow-border rounded-lg h-full' transition:slide>
    <div class='h-full overflow-y-auto px-4 flex flex-col gap-1 scrollbar'>
      <div class='sticky top-0 w-full bg-base-100 pb-2 z-20'>
